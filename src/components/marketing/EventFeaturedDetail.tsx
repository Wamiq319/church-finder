...
interface EventFeaturedDetailProps {
  isFeatured: boolean;
...
export const EventFeaturedDetail = ({
  isFeatured,
  featuredUntil,
  eventId,
  onGetFeaturedClick,
}: EventFeaturedDetailProps) => {
  ...
  const handleGetFeaturedClick = () => {
    if (onGetFeaturedClick) {
      ...
      // Default behavior - redirect to create-event page
      router.push(`/dashboard/create-event?eventId=${eventId}&step=2`);
    }
  };
      ...
      <div className="bg-gradient-to-br from-green-50 to-emerald-50 border-2 border-green-200 rounded-lg p-4 max-h-64 flex flex-col justify-center">
        <div className="text-center">
          ...
          <h3 className="text-base font-bold text-gray-800 mb-1">
            Feature Your Event for $5/week
          </h3>

          <p className="text-gray-600 mb-2 max-w-xs mx-auto text-xs">
            Boost your event's visibility with our featured listing option.
          </p>
